...
$(document).ready(function() {
	...
	// Global Color
	$('head style').append('h1, h1 a, h2, h2 a, h3, h3 a, h4, h4 a, h5, h5 a, h6, h6 a  {font-family:"'+Heading_Font+'"; } html, body, div, p, table, tr, td, th, tbody, tfoot, ul, li, ol, dl, dd, dt, fieldset, cite, input, select, textarea, button, a, section, article, aside, header, footer, nav {font-family:"'+Site_Font+'"; }  body, .btn:hover {background-color:#'+page_background_color+'!important;} .tabs li a:hover, #contact-form .btn {background-color:#'+main_color+'; }  h1, header ul.list-inline li a:hover, .brand a:hover, span.section-icon, .form-dark input[type=submit] {color:#'+main_color+'} header, .tabs, span.section-icon {background-color:#'+color2+';}  h4 {color:#'+color3+';}  .form-dark {background-color:#'+color4+';}  ::selection {background-color:#'+main_color+'; color:#fff;} ::-moz-selection {background-color:#'+main_color+'; color:#fff;} ');
